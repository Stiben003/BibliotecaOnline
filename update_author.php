...
$query = extraerAutor(base64_decode($_GET['id']));
...
<div class="container">
    <div class="container-flat-form">
        <div class="title-flat-form title-flat-blue">Actualizar Autor</div>
        <div class="panel panel-default">
            <div class="container">
                <form action="php/registros-crud/author.php?accion=UDT" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-lg-8 col-offset-2 col-xs-12 col-xs-offset-0">
                            ...
                            <div class="form-group">
                                <a href="manage-authors.php" class="btn btn-info">Atras</a>
