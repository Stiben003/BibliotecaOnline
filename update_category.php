...
$query = extraerCategoria(base64_decode($_GET['id']));
...
<div class="container">
    <div class="container-flat-form">
        <div class="title-flat-form title-flat-blue">Actualizar categoría</div>
        <div class="panel panel-default">
            <div class="container">
                <form action="php/registros-crud/category.php?accion=UDT" method="post">
                    <div class="form-group">
                        <label class="control-label">Código <span style="color:red">*</span></label>
                        <input type="text" name="codigo" id="codigo" require="" readonly="" class="form-control" value="<?php echo $row['idcategoria'] ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-lg-8 col-offset-2 col-xs-12 col-xs-offset-0">
                            ...
                            <div class="form-group">
                                <a href="manage-categories.php" class="btn btn-info">Atras</a>
