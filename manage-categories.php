                    ...
                    while ($row = $query->fetch_assoc()) {
                        echo"
                            <tr>
                                ...
                                <td>".$row['estado']."</td>
                                <td> <a data-toggle='tooltip' title='Editar' href='update_category.php?id=".base64_encode($row['idcategoria'])."' class='btn btn-primary'> <i class='icon ion-md-create'></i> </a> </td>
                                <td> <a data-toggle='tooltip' title='Anular' href='php/registros-crud/category.php?accion=DLT&id=".$row['idcategoria']."' class='btn btn-danger'> <i class='icon ion-md-trash'></i> </a></td>
                        ";
                    }
                ?>
